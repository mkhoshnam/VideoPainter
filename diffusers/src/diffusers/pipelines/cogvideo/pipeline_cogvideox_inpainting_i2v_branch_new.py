...
class CogVideoXI2VDualInpaintPipelineNew(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        masked_video: List[PIL.Image.Image] = None,
        ...
        # 5. Preprocess mask and video
        crops_coords = None
        resize_mode = "default"

        original_video = video
        init_video = self.video_processor.preprocess_video(original_video, height=height, width=width)
        ...
        mask_condition = self.masked_video_processor.preprocess_video(masked_video, height=height, width=width)
